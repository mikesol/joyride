...
mockLongs makeLongs@{ textures: Textures textures } = toScene
  ...
  score = mapWithIndex (\uniqueId x -> union { uniqueId } x) $ { column: C4, appearsAt: Beats 0.0 }
    : { column: C10, appearsAt: Beats 3.0 }
    : { column: C10, appearsAt: Beats 8.0 }
    : { column: C10, appearsAt: Beats 12.0 }
    : { column: C2, appearsAt: Beats 14.0 }
    : { column: C2, appearsAt: Beats 21.0 }
    : { column: C2, appearsAt: Beats 26.0 }
    : Nil
